      ...
      {loading ? (
        ...
        <form className="admin-form-card" onSubmit={handleSubmitForm}>
          ...
          <div className="admin-form-grid">
            ...
            <label>
              Vai trò
              <input value={form.role} onChange={(e) => handleFormChange('role', e.target.value)} />
            </label>
            ...
            <label>
              Giới tính
              <input value={form.gender} onChange={(e) => handleFormChange('gender', e.target.value)} />
            </label>
            <label>
              Ngày sinh
  ...
  return (
    <div className="admin-page">
      <header className="admin-topbar">
        <h1 className="admin-topbar__title">Quản trị nhân viên</h1>
