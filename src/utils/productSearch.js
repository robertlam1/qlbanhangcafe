/**
 * Chuẩn hoá chữ để tìm kiếm (bỏ dấu, thường).
 */
...
/**
 * Điểm càng cao = càng khớp (tên gần giống / chứa từ khóa).
 */
...
/**
 * Trả về danh sách sản phẩm xếp theo độ liên quan (cao → thấp).
 */
...
/**
 * Dùng cho trang danh sách: lọc tất cả sản phẩm có điểm > 0, giữ thứ tự gần giống.
 */
